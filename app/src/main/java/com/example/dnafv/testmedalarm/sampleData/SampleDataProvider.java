package com.example.dnafv.testmedalarm.sampleData;
...
/**
 * This class is used to create 2 Data Collections
 * 1. Lists - Ordered collection saved as an Array
 * 2. Map Interfaces - Unordered Collection of key->value pairs
 * */
public class SampleDataProvider {

    //Lists will be instances of the DataItem Class used before
    //The next one is an instance of the MapInterface
    public static List<DataItem> dataItemList;
    //key=String value=DataItem where each key will be the PK
    public static Map<String,DataItem>dataItemMap;


    //They are static fields and need to be initialized, both objects where ArrayList & HashMap are
    ...
    static {
        ...
        //Paste Items from gist(https://gist.github.com/davidgassner/5a7f929b0b94eadbd4d15ea58afc771c) here:
    ...
    //Static method that accepts an instance of the dataItem class and adds it to the list and map
    //Both references have access to a single item.
    //Next step is to create dummy data that will eventually come from a database
